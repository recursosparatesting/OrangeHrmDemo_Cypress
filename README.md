...
La ATM tiene dos casos de prueba y permite elegir uno de ellos al momento de la ejecucion:   
...
El pipeline se ejecuta cuando se realiza push y en este caso toma los valores de las variables por defecto:    
navegador: chrome  
prueba a ejecutar: credencialesCorrectas  
usuario: Admin    
contraseña: admin123     

El pipeline tambien se puede ejecutar a peticion, yendo a:  Actions -->  Pruebas Orange HRMDemo con Cypress  --> Run workflow.    Alli se pueden cambiar estos valores:   
